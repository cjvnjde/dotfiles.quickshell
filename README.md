...
network, calendar and notes controls, standalone Codex token usage, and a
Codex-backed AI quick chat. See [`main/README.md`](main/README.md#ai-quick-chat) for sandbox setup,
